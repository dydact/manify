...
def _test_base_model(model, X_train, X_test, y_train, y_test):
...
def _test_kappa_gcn_model(model, X_train, X_test, y_train, y_test, pm):
...
def test_all_classifiers():
    ...
    for model_class in [
        ...
        _test_base_model(model, X_train, X_test, y_train, y_test)
